            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-50 dark:bg-[#262626] border border-gray-200 dark:border-[#333333] text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-200"
                />
